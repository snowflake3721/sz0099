...
<div id="paragragh_${entity.id}"> <!--div wrapper-->
	...
	<div class="panel panel-danger" id="id_panel_paragId${entity.paragId}" name="paragraph">
		  <div class="panel-heading">
		    	...
		    	<button type="button" class="btn btn-xs btn-warning pull-left" onclick="saveParagraphSingle('${entity.paragId}','/sz0099/ood/article/manage/paragraph/mergeSingle')">保存★</button>
		    	...
		    	<button type="button" class="btn btn-xs btn-danger pull-right" onclick="deleteParagraphSingle('${entity.paragId}', '/sz0099/ood/article/manage/paragraph/deleteSingle')">删除</button>
		  ...
		  <div class="panel-body">
			  ...
			  <div class="form-group form-group-sm">
			    <label for="id_parag_name${entity.paragId}" class="text-danger"><small>段落右角标(简短，少于20字符)</small></label>
				...
				<div class="file-loading">
					<input id="id_file_${entity.paragId}" data-devId="sz0099" data-project="ood" data-module="article" data-variety="article" data-strategy="1" data-position="paragragh" data-mainId="${entity.mainId}" data-subId="${entity.paragId}" type="file" multiple name="files" />
				</div>
				<p class="text-danger">
					<small>
		    ...
		    <div class="panel-footer">
		    	...
		    	<button type="button" class="btn btn-sm btn-warning pull-right" onclick="saveParagraphSingle('${entity.paragId}','/sz0099/ood/article/manage/paragraph/mergeSingle')">保存当前段落★</button>
		    	</p>
		    </div>
	  </div><!--end panel-->
</div><!--end div wrapper-->
...
<div id="paragragh_view_${entity.id}"> <!--div wrapper-->
			   ...
			   <h4 class="text-center"><strong>${paragraph.title}</strong></h4>
			   <p class="text-left">
...
<#assign photoParagList=paragraph.photoList />
	<#if photoParagList! && photoParagList?size gt 0>
	   <ul class="list-inline" >
		...
		<#if photoParag!>
				<li>
			    	<a href='javascript:void(0)' onclick="showBigViewOnly('${photoParag.fullurl}',1024,'${photoParag.width}','${photoParag.aid}')">
					...
					<p class="text-center"><small>${photoParag.title}</small></p>
		    	</li>
		</#if>
		</#list>
		</ul>
