			  ...
			  <div class="panel-heading">
			    ...
			    <span class="pull-right"><small><strong> 
			    	<a href='javascript:void(0)' onclick="showSaywordHistory('${article.nickname}','${article.sayword.description}', '@${DateUtils.formatToString(article.refreshTime ,'yyyy-MM-dd')}')">
				  	${ShowNameUtil.getShowname(article.penname, article.nickname, 'dml')}
				 	</a>
			  ...
			  <div class="panel-body" sytle="margin-bottom:0px">
				  	<div class="row">
						  <div class="col-xs-8 col-md-8">
						    ...
						    <p>${getSubstring(article.description,40,'暂无')}</p>
						  ...
						  <div class="col-xs-4 col-md-4">
						    	...
						    	<@M_showImageForView imageList=itemSingle.coverList />
						    	 -->
						    	<@Mg_layout_imgCoverRollerH_single entity0=article idPre="layout_list" withPreIntro=false withTitle=false withSubTitle=false showLoadMore=false showDot=false showPreNext=false/>
