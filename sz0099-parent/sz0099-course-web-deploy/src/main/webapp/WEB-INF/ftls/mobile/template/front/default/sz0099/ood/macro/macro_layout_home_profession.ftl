...
<#-- 图文横滚 -->
<#macro M_layout_headRoller ref=null dto=null showHeadTip=false withPreIntro=true withTitle=true withSubTitle=true showListLoadMore=false showPreNext=true showDot=true btnLabel="更多专业技能" idPre="ly_head">
<#if dto!>
	    ...
	    <#if positionHas>
	          <#list positionList as positionEntity>
	          	...
	          	<#elseif bannerList!  && bannerList?size &gt; 0 >
	          	  ...
	          	  <#if coverImageUrl! >
		          <div class="item <#if entityIndex2==0>active</#if>" style="height:180px">
	     ...
	     <#if categoryHas>
	          ...
	          <#assign categoryEntity=category.profession/>
		          ...
		          <div class="item <#if entityIndex2==0>active</#if>" style="height:180px">
		            	...
		            	<img data-src="holder.js/240x180/auto/#777:#777" alt="${categoryEntity.title}" height="180px"  src="${coverImageUrl}" title="${categoryEntity.title}" data-holder-rendered="true">
		          		<div class="carousel-caption">
		          			<#if withPreIntro>
...
<#macro M_layout_explorerRoller ref=null dto=null showHeadTip=false withPreIntro=true withTitle=false withSubTitle=true showLoadMore=false showLoadMore=true showDot=false showPreNext=false showPenname=false linkable=true btnLabel="探路行动" idPre="ly_explorer_">
<#if dto!>
	<#assign positionPage=dto.positionPage/>
	<#assign categoryPage=dto.categoryPage/>
	<#assign positionHas=false/>
		    			...
		    			<#assign isEvenItem=categoryEntity?is_even_item />
		    				<#if isOddItem>
						  	<div class="row">
								  ...
								  <div class="col-xs-6 col-md-4">
								  <p>---888---8----</p>
								    	<@M_layout_imgCoverRollerH_single entity0=categoryEntity.profession idPre=idPre withPreIntro=withPreIntro withTitle=withTitle withSubTitle=withSubTitle showLoadMore=showLoadMore showDot=showDot showPreNext=showPreNext showPenname=showPenname linkable=linkable/>
								  </div>
...
<#macro M_layout_outdoorWord2Img dto=null showHeadTip=false url="#" showListLoadMore=false withPreIntro=false withTitle=false withSubTitle=false showLoadMore=false showDot=false showPreNext=false showPenname=false linkable=false btnLabel="户外专享" idPre="ly_outdoor_">
<#if dto!>
	<#assign positionPage=dto.positionPage/>
	<#assign categoryPage=dto.categoryPage/>
...
<#macro M_layout_todayScreen ref=null dto=null showHeadTip=false showListLoadMore=false btnLabel="往日神技..." screenBtnLabel="观览★★★" idPre="ly_today">
<#if dto!>
	<#assign positionPage=dto.positionPage/>
	<#assign categoryPage=dto.categoryPage/>
	<#assign positionHas=false/>
...
<#macro M_layout_farmstayRollerMulti ref=null dto=null showHeadTip=false showListLoadMore=false btnLabel="吃的世界" idPre="ly_farmstay">
...
<#macro M_layout_outdoorRollerMulti ref=null dto=null showHeadTip=false showListLoadMore=false btnLabel="野餐乐趣" idPre="ly_outdoor">
<@M_layout_eatRollerMulti ref=ref dto=dto idPre=idPre showHeadTip=showHeadTip showListLoadMore=showListLoadMore btnLabel=btnLabel idPre=idPre/>
</#macro>

<#macro M_layout_eatRollerMulti ref=null dto=null showHeadTip=false showDot=true withPreIntro=true withTitle=true withSubTitle=true showPenname=true showPreNext=false showListLoadMore=true showLoadMore=false mainCircle=true btnLabel="吃的世界" idPre="ly_eat">
<#if dto!>
	<#assign positionPage=dto.positionPage/>
	<#assign categoryPage=dto.categoryPage/>
	<#assign positionHas=false/>
			          ...
			          <div class="item <#if slideIndex2==0>active</#if>">
			            	...
			            	<#if showPenname>
								  ...
								  <#if entity0.professionTagList!?size gt 0 > 
								  	<@M_showTagListRandom productTagList=entity0.professionTagList fontSize=12 randomSize=false withWrapper=false/>
								  	</#if>
				  					</strong>
				  					</span>
...
<#macro M_layout_recommendImg3Multi dto=null showHeadTip=false withPreIntro=true withTitle=true withSubTitle=true showPenname=true showListLoadMore=true mainCircle=true btnLabel="技能推荐" idPre="ly_recommend">
<#if dto!>
	<#assign positionPage=dto.positionPage/>
	<#assign categoryPage=dto.categoryPage/>
	<#assign ref=dto.position/>
...
<#macro M_layout_killImg2Word dto=null showHeadTip=false url="#" showListLoadMore=false withPreIntro=false withTitle=false withSubTitle=false showLoadMore=false showDot=false showPreNext=false showPenname=false linkable=false btnLabel="大侠必杀" idPre="ly_kill">
<#if dto!>
	<#assign positionPage=dto.positionPage/>
	<#assign categoryPage=dto.categoryPage/>
	<#assign ref=dto.position>
...
<#macro M_layout_artisanImg2Img dto=null showHeadTip=false url="#" showListLoadMore=false withPreIntro=false withTitle=false withSubTitle=false showLoadMore=false showDot=false showPreNext=false showPenname=false linkable=false btnLabel="能工巧匠" idPre="ly_artisan">
<#if dto!>
	<#assign positionPage=dto.positionPage/>
	<#assign categoryPage=dto.categoryPage/>
	<#assign ref=dto.position>
...
<#macro M_layout_actionFlagImg2Word ref=null dto=null showHeadTip=false url="#" showListLoadMore=false withPreIntro=false withTitle=false withSubTitle=false showLoadMore=false showDot=false showPreNext=false showPenname=false linkable=false btnLabel="插旗行动回顾" idPre="ly_act_Flag2">
<#if dto!>
	<#assign positionPage=dto.positionPage/>
	<#assign categoryPage=dto.categoryPage/>
	<#assign positionHas=false/>
...
<#macro M_layout_searchImg2Word dto=null idPre="ly_search" showHeadTip=false url="#" showListLoadMore=true withPreIntro=false withTitle=false withSubTitle=false showLoadMore=false showDot=false showPreNext=false showPenname=false linkable=false>
<#if dto!>
