...
<div class="container " id="body_content">
 <@M_navBreadForManage category="product" subCategory="detail"  entity=entity/>
  <div class="text-center"><h3>选择一个产品查看</h3></div>
  <p>${entity.respMsg}</p>
  
  <div class="row">
		 <div class="col-md-12">
		    <div class="input-group">
		      <input type="hidden" id="id_search_url" name="searchUrl" class="form-control" value="/sz0099/ood/product/manage/queryProductList">
  ...
  <@M_coeProductDetailPage detailPage=page moreLoaded="false" url="/sz0099/ood/product/manage/detail/" condition=entity/>
  
  <@M_navBottomForManage category="product" subCategory="detail"  entity=entity/>
</div>
