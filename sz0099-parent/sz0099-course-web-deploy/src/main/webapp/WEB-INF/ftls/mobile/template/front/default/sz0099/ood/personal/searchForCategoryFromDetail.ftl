...
<div class="container " id="body_content">
	<div id="id_profession_personal" class="container" style="z-index:5002"></div>
  	<@M_professionCategoryForSearchFromDetail entityPage=page categoryRef=entity categoryTree=categoryTree url="/sz0099/ood/personal/profession/searchForCategoryFromDetail"/>
