...
<div class="container " id="body_content">
  	<@Mg_articleCategoryForSearch entityPage=page categoryRef=entity categoryTree=categoryTree/>
	<#--
    <@shiro.user>
 	<p> 大神 <span class="text-primary" onclick="showSaywordOwn('${currentUser.nickname}','${currentUser.sayword.description}')">§ <@shiro.principal property="nickname"/> § </span> <span class="badge"><span class="glyphicon glyphicon-grain"></span></span> <@M_layout_tagPageSimple positon=null entityPage=tagPage idPre="ly_tag"/></span>  <a href="/sz0099/ood/home/article/index/recommend?st=general" class="pull-right">回首页&nbsp;&nbsp;</a></p>
	</@shiro.user>
