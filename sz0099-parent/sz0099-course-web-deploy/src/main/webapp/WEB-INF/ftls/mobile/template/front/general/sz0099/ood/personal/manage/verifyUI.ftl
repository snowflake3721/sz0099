...
<@M_navBreadForMy category="info" subCategory="verify" entity=entity/>
 -->
<@M_navBreadForCategory category="myIndex" subCategory="verify" entity=entity/>
  <div class="text-center"><h4>身份证认证审核</h4>
  <p>当前状态： ${CoeUserVerify.IDSTATUS.getLabel(entity.idstatus)}</p>
  <#assign idstatus=entity.idstatus/>
						...
						<#if !readonly>	
							<label class="col-sm-2 control-label text-danger" for="id_file_${entity.id}1">身份证正面★</label>
							 ...
							 <div class="file-loading">
								<input id="id_file_${entity.id}1" data-devId="sz0099" data-project="ood" data-module="auth" data-variety="personal" data-position="identity" data-strategy="3" data-mainId="${entity.id}"  data-subId="1" type="file" name="files" />
							 </div>
							 </div>
							 ...
							 <div id="id_messageTip_preview1" class="text-center"></div>
					      	 ...
					      	 <div class="input-group input-group-sm">
							 <div class="file-loading">
								<input id="id_file_${entity.id}2" data-devId="sz0099" data-project="ood" data-module="auth" data-variety="personal" data-position="identity" data-strategy="3" data-mainId="${entity.id}" data-subId="2" type="file" name="files" />
							 </div>
							 </div>
...
<script>document.write("<script type='text/javascript' src='/assets/theme/general/sz0099/ood/product/personal/verify.js?v=1.0.0'><\/script>");</script>
