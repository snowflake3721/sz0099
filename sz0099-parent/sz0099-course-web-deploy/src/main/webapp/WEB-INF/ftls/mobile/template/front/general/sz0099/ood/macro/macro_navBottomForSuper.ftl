			   ...
			   <li class="dropdown pull-right">
			          ...
			          <ul class="dropdown-menu">
			            <li><a href="/sz0099/ood/home/article/index/recommend?st=general">首页</a></li>
			             <li><a href="/sz0099/ood/home/profession/index/recommend?st=general">技能圈</a></li>
			             <li class="<#if category=="qunxia">active</#if>"><a href="/sz0099/ood/home/article/index/recommend?st=general">户外圈</a></li>
			          </ul>
			   </li>
	    </ul>	
  </div>
