...
<#macro M_CategoryExtendList contentList=null url="/sz0099/ood/category/extend/manage/create?id="> 
	...
	<#list contentList as content>
		<li id="id_li_${content.id}" class="list-group-item <#if content?is_even_item>list-group-item-warning</#if>">	  
	  	<span class="pull-left"
	  		onclick="deleteVarietySingle('${content.id}', '/sz0099/ood/category/extend/manage/delete', 'id_li_${content.id}', 'id_tip')"
	  	>
