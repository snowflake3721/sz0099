...
<#macro M_activitySearch page=null entity=null searchUrl="/sz0099/ood/position/manage/selectNeedBindRefList">
<#assign viewType=PositionRef.VIEWTYPE_4_ACTIVITY.valueInt />
...
<input type="text" id="id_search_mainNo${viewType}${entityId}" name="activityNo" class="form-control" placeholder="编号，精确定位" value="${entity.activityNo}">
</div>
</#macro>

<#macro M_activitySearchForSelect page=null entity=null searchUrl="/sz0099/ood/position/manage/selectNeedBindRefList">
<@M_activitySearch page=page entity=entity searchUrl=searchUrl />
<@M_selectActivityProfessionPage page=page positionRef=entity moreLoaded="true" url=searchUrl condition=entity />
</#macro>