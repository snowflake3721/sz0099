...
<#-- 图文横滚 -->
<#macro M_layout_tagsForActivity positon=null entityPage=null idPre="layout_" showHeadTip=false withPreIntro=false withTitle=true withSubTitle=false showLoadMore=false>
<#if entityPage??>
...
<#assign totalPages=entityPage.totalPages />
	...
	<#assign size=entityList?size/>
		...
		<li>
			<#assign tagList=entity0.activityTagList/>
			<#if tagList!>
