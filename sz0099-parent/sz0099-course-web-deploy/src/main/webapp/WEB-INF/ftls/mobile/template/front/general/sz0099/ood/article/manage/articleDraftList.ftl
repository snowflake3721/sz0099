...
<@M_navBreadForCategory category="article" subCategory="draftList"  entity=entity/>
<div class="row">
	 <div class="col-md-12">
	    <div class="input-group">
	      ...
	      <input type="text" id="id_data_articleNo" name="articleNo" class="form-control" placeholder="编号，精确定位" value="${entity.articleNo}">
	    </div>
  	 </div>
</div>
...
<ul class="nav nav-tabs" role="tablist" id="id_tab_list">
	    ...
	    data-toggle="tab" 
	    data-url="/sz0099/ood/article/manage/queryDraftList/ansy"
	    data-loaded="0"
	    ...
	    data-toggle="tab" 
	    data-url="/sz0099/ood/article/manage/queryArticleList/ansy"
	    data-loaded="0"
	    ...
	    data-toggle="tab" 
	    data-url="/sz0099/ood/article/manage/queryArticleManageList/ansy"
	    data-loaded="0"
	    ...
	    data-toggle="tab" 
	    data-url="/sz0099/ood/article/manage/searchArticleList/ansy"
	    data-loaded="0"
	...
	function ansySearch(position, tabIdShow){
		...
		var loaded = tabPanel.attr("data-loaded");
	  	if(loaded==0){
			...
			ansySearchForArticleManage(position);
	  	}
	  	tabPanel.tab('show');
	}
