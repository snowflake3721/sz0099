...
<#include "mobile/template/front/general/sz0099/ood/macro/macro_coe_order_list.ftl">
<#include "mobile/template/front/general/sz0099/ood/macro/macro_coe_order_common.ftl">
...
<script>document.write("<script type='text/javascript' src='/assets/theme/general/sz0099/ood/product/personal/myCoeOrderList.js?v=1.0.13'><\/script>");</script>
<script>document.write("<script type='text/javascript' src='/assets/theme/general/sz0099/ood/order/order_manage.js?v=1.0.1'><\/script>");</script>
