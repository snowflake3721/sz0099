...
<#macro M_coeArticleCreate entity=null url="/sz0099/ood/home/article/index">   
<!--创建文章--> 
...
<div class="list-group">
  <a href="javascript:void(0)" class="list-group-item active">
    ...
    <p class="list-group-item-text">1.录入文章>>标题</p>
	<p class="list-group-item-text">2.录入文章>>内容</p>
	<p class="list-group-item-text">3.录入文章>>标签(可选)</p>
	<p class="list-group-item-text">4.录入文章>>发布</p>
  </a>
</div>
 </#macro>
...
<ul class="nav nav-tabs" role="tablist" id="id_tab_create">
	    <li role="presentation" class="active" ><a href="#panel_baseinfo" aria-controls="panel_baseinfo" role="tab" data-toggle="tab" data-saveUrl="/sz0099/ood/article/manage/merge/baseinfo">标题</a></li>
	    <#-- 
...
<div class="tab-content">
    ...
    <div id="id_messageTip_baseinfo${contentModel.id}" class="text-center"></div>
		 ...
		 <div class="form-group form-group-sm">
		    ...
		    data-saveUrl="/sz0099/ood/article/manage/merge/title/ansy"
		  ...
		  <div class="form-group form-group-sm">
		    <div class="text-danger">概要(少于1000字符)★
		    ...
		    <textarea id="id_area_description${contentModel.id}" rows="8" class="form-control" placeholder="总结一下本文的精华，少于1000字"
		     ...
		     data-saveUrl="/sz0099/ood/article/manage/merge/description/ansy"
		     data-saved="0"
		  ...
		  <div class="form-group form-group-sm">
		    ...
		    onblur="watchPenname('id_penname${contentModel.id}',  '${contentModel.id}')"
		    data-saveUrl="/sz0099/ood/article/manage/merge/penname/ansy"
		    data-saved="0"
		    onkeyup="watchPenname('id_penname${contentModel.id}', '${contentModel.id}')"
		  ...
		  <div class="text-center">
    		...
    		<#-- 封面图开始 -->
    			<@Mg_uploadConverImage id="coverUploaderInput"+contentModel.id mainId=contentModel.id subId=PhotoCover.SUBID_COVER_HEAD strategy=1 extend=coverExtend/>
				...
				<@Mg_coverImageForEdit id="coverUploaderInput"+contentModel.id imageList=contentModel.coverList subId=PhotoCover.SUBID_COVER_HEAD />
				</ul>
				</div>
				<#-- 封面图结束 -->
				<br/>
    			<@Mg_uploadBannerImage id="bannerUploaderInput"+contentModel.id mainId=contentModel.id subId=PhotoBanner.SUBID_BANNER_HEAD strategy=1 extend=bannerExtend/>
				<#-- 头部滚动图开始 -->
				...
				<@Mg_bannerImageForEdit id="bannerUploaderInput"+contentModel.id imageList=contentModel.bannerList subId=PhotoBanner.SUBID_BANNER_HEAD />
				</ul>
				</div>
				<#-- 头部滚动图结束 -->
    </div>
    ...
    <div role="tabpanel" class="tab-pane fade" id="contentPhoto" data-saveUrl="">
    	...
    	<button class="btn btn-primary btn-xs" type="button" onclick="resetOrderSeq('${contentModel.id}','编号重排','/sz0099/ood/article/manage/paragraph/resetOrderSeq')">编号重排</button> 
    	<button class="btn btn-danger btn-xs" type="button" onclick="refreshParagraphOrder('${contentModel.id}','/sz0099/ood/article/manage/paragraph/editListUI','#contentPhoto')">刷新排序</button> 
    ...
    <div role="tabpanel" class="tab-pane fade" id="contentTag" data-saveUrl="">
    	...
    	<br/>
    	<p><strong>1.恰当的标签，可增加文章搜索机率，最多加<b> 5  </b>个</strong></p>
    ...
    <div role="tabpanel" class="tab-pane fade" id="panel_publish" data-saveUrl="">
    	<br/>
    	<p><strong>1.请确认[标题、内容]必填步骤已填写完毕！<div class="text-danger text-center">★ 为必填项</div></strong></p>
