...
<@M_navBreadForMy category="info" subCategory="recieveImg" entity=entity/>
  ...
  <p>当前认证状态： ${CoeUserVerify.IDSTATUS.getLabel(entity.idstatus)}</p>
				 ...
				 <#-- begin payRecieve -->
				  <div class="form-group form-group-sm">
						 ...
						 <div class="file-loading">
							<input id="id_file_${entity.id}4" data-devId="sz0099" data-project="ood" data-module="product" data-variety="personal" data-position="identity" data-strategy="4" data-mainId="${entity.id}" data-subId="4" type="file" name="files" />
						 </div>
						 </div>
