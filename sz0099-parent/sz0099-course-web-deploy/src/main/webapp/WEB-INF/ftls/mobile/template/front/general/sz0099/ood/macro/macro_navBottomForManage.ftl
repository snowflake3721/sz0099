	    ...
	    <ul class="nav nav-pills">
		      <li class="dropdown">
			   ...
			   <#elseif category=="article">
			      <li class="dropdown">
				          ...
				          <ul class="dropdown-menu">
				            ...
				            <li role="separator" class="divider"></li>
				             -->
				            <li class="<#if subCategory=="draftList">active</#if>"><a href="/sz0099/ood/article/manage/queryDraftList">列表</a></li>
				            <#-- 
				            <li role="separator" class="divider"></li>
			   ...
			   <li class="dropdown pull-right">
			          ...
			          <ul class="dropdown-menu">
			             <li><a href="/sz0099/ood/home/article/index/recommend?st=general">首页  <span class="glyphicon glyphicon-chevron-right text-primary"></span></a></li>
			             <li><a href="/sz0099/ood/home/profession/index/recommend?st=general">技能圈  <span class="glyphicon glyphicon-chevron-right text-primary"></span></a></li>
			             <li class="<#if category=="qunxia">active</#if>"><a href="/sz0099/ood/home/article/index/recommend?st=general">户外圈  <span class="glyphicon glyphicon-chevron-right text-primary"></span></a></li>
			          </ul>
			   </li>
	    </ul>	
  </div>
...
<ol class="breadcrumb">
  ...
  <li><a href="#">产品</a></li>
   ...
   <#elseif category=="article">
	...
	<#if subCategory=="new">
	<li><a href="/sz0099/ood/article/manage/create?id=">编辑</a></li>
	</#if>
