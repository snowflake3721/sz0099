		...
		<form id="id_form_sys_user_login" role="form" action="/sys/doLogin" method="post" enctype="application/x-www-form-urlencoded">
				  ...
				  <div class="form-group row">
				    <label class="col-sm-2 col-form-label" for="id">系统ID:
				 	...
				 	<div class="col-sm-10">
				    <input type="text" name="id" class="form-control" value="${entity.id}" id="id" placeholder="系统ID" />
				    </div>
				   </div>
				  ...
				  <div class="form-group row">
				    <label class="col-sm-2 col-form-label" for="appId">APPID:
				 	...
				 	<div class="col-sm-10">
				    <input type="text" name="appId" value="${entity.appId}" class="form-control" id="appId" placeholder="APPID" />
				    </div>
				  </div>
				  <div class="form-group row">
				    <label class="col-sm-2 col-form-label" for="openid">openid:
				 	...
				 	<div class="col-sm-10">
				    <input type="text" name="openid" value="${entity.openid}" class="form-control" id="openid" placeholder="openid" />
				    </div>
				  </div>
