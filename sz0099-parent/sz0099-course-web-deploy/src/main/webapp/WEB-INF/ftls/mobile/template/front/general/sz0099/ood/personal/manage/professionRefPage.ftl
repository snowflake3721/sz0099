...
<#include "mobile/template/front/default/sz0099/ood/macro/macro_coe_professionRef_list.ftl">
...
<#if entity.success == 1>
<@M_professionRefPageEdit page=pageResult entity=entity deep=0 wrapperId="" tipId="" editWrapperId=""/>
</#if>
