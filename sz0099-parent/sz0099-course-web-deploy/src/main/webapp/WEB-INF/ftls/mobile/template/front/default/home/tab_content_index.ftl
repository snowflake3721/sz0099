<!-- Tab panes -->
<div class="tab-content" style="boder-top:0px">
    ...
    <div role="tabpanel" class="tab-pane" id="equipments">
    	equipments is developing, waite a monent for the service...if you need some equipment, you can add wechat number "ly275060435" to ask.Thank you!
    </div>
</div>