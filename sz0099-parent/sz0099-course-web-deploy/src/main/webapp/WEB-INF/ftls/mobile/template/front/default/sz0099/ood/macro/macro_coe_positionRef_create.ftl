...
<#-- 关联编辑面板 begin -->
<#macro M_positionRefEdit entity=null >
...
<@M_dropdownBarSame idPre="id_ref_" entityId=entity.id propertyContext=PositionRef.STATUS current=PositionRef.STATUS.getContext(entity.status,0) readonly=true />
...
<div class="form-group form-group-sm">
    <label class="col-sm-2 control-label" for="id_file_${entity.id}">
   	<div id="id_ref_photoPreview" class="container">
	  ...
	  -->
	<div class="container"> 
		<strong>头部图:</strong><@M_showImageForRefEdit imageList=entity.bannerList width="40px" />  
	</div>
</div>
</form>
<script>
