...
<@M_navBreadForCategory category="activity" subCategory="draftList"  entity=entity/>
<div class="row">
	 <div class="col-md-12">
	    <div class="input-group">
	      ...
	      <input type="text" id="id_data_activityNo" name="activityNo" class="form-control" placeholder="编号，精确定位" value="${entity.activityNo}">
	    </div>
  	 </div>
</div>
...
<ul class="nav nav-tabs" role="tablist" id="id_tab_list">
	    ...
	    data-toggle="tab" 
	    data-url="/sz0099/ood/activity/manage/queryDraftList/ansy"
	    data-loaded="0"
	    ...
	    data-toggle="tab" 
	    data-url="/sz0099/ood/activity/manage/queryActivityList/ansy"
	    data-loaded="0"
	    ...
	    data-toggle="tab" 
	    data-url="/sz0099/ood/activity/manage/queryActivityManageList/ansy"
	    data-loaded="0"
	    ...
	    data-toggle="tab" 
	    data-url="/sz0099/ood/activity/manage/searchActivityList/ansy"
	    data-loaded="0"
...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active fade in" id="panel_draft">
		  <@M_coeActivityDraftList draftList=draftList/>
    </div>
	...
	function ansySearch(position, tabIdShow){
		...
		var loaded = tabPanel.attr("data-loaded");
	  	if(loaded==0){
			...
			ansySearchForActivityManage(position);
	  	}
	  	tabPanel.tab('show');
	}
