...
<div class="tab-content">
    ...
    <div id="id_messageTip_baseinfo${contentModel.id}" class="text-center"></div>
    	  ...
    	  <div class="form-group form-group-sm">
		    <label for="id_name${contentModel.id}"  class="text-danger">名称(少于32字符)★</label>
		    <input type="text" id="id_name${contentModel.id}" name="name" 
		     onkeyup="syncTitle(this,'${contentModel.id}')"  
    		 onafterpaste="syncTitle(this,'${contentModel.id}')"
		    value="${contentModel.name}" class="form-control" placeholder="文章名称">
		  </div>
		  <#-- 
    	  <div class="form-group form-group-sm">
		    <label for="id_title${contentModel.id}">文章标题(少于40字符)</label>
		    <input type="text" id="id_title${contentModel.id}" name="title" value="${contentModel.title}" class="form-control" placeholder="文章标题">
		  </div>
		   -->
		  <div class="form-group form-group-sm">
