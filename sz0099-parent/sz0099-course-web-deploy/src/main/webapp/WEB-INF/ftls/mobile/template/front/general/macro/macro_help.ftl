...
<div class="row">
<div class="col-xs-4"> <img src="/assets/common/help/editor/align/help_editor_align_1.jpg" class="img-responsive" alt="1.原文是左对齐；点对齐，弹出选择对齐方式面板，选右对齐" onclick="popBigViewOnly('/assets/common/help/editor/align/help_editor_align_1.jpg','段落对齐-1.例如：原文是左对齐；点对齐，弹出选择对齐方式面板，选右对齐', false)"></div>
<div class="col-xs-4"> <img src="/assets/common/help/editor/align/help_editor_align_2.jpg" class="img-responsive" alt="2.查看改后结果，点保存" onclick="popBigViewOnly('/assets/common/help/editor/align/help_editor_align_2.jpg','段落对齐-2.查看改后结果，点保存', false)"></div>
<div class="col-xs-4"> <img src="/assets/common/help/editor/align/help_editor_align_3.jpg" class="img-responsive" alt="3.可点[预览]按钮，全文查看一下" onclick="popBigViewOnly('/assets/common/help/editor/align/help_editor_align_3.jpg','段落对齐-3.可点预览按钮，全文查看一下', false)"></div>
</div>
</#macro>