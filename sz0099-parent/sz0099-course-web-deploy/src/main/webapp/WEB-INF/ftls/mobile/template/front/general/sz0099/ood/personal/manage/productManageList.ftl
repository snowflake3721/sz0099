...
<div class="container " id="body_content">
 <@M_navBreadForManage category="sale" subCategory="list"  entity=entity/>
  <p>${entity.respMsg}</p>
  <div class="row">
		 <div class="col-md-12">
		    <div class="input-group">
		      <input type="hidden" id="id_search_url" name="searchUrl" class="form-control" value="/sz0099/ood/personal/profession/queryProductManageList">
  ...
  <@M_navBottomForManage category="sale" subCategory="list"  entity=entity/>
</div>
