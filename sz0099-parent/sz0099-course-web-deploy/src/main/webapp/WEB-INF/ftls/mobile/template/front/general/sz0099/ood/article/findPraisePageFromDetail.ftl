...
<div class="container " id="body_content">
    ...
    <@M_articleSearchPraisePage entity=entity url="/sz0099/ood/article/findArticleForPraisePage/"/>
    <@shiro.user>
	...
	<hr/>
	<p>===111====</p>
	<@M_mainTypeForPraisePage entity=entity url="/sz0099/ood/article/findArticleForPraisePage/" showListLoadMore=true/>
	<@M_introduction/>
