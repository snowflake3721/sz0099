...
<#include "mobile/template/front/default/sz0099/ood/macro/macro_coe_article_profession_search.ftl">
<#include "mobile/template/front/default/sz0099/ood/macro/macro_coe_article_profession_list.ftl">
<#if entity!>
