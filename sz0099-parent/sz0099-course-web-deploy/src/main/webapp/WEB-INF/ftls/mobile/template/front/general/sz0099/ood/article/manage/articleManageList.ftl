...
<div class="container " id="body_content">
 <@M_navBreadForManage category="article" subCategory="manageList"  entity=entity/>
  <p>${entity.respMsg}</p>
  <div class="row">
		 <div class="col-md-12">
		    <div class="input-group">
		      <input type="hidden" id="id_search_url" name="searchUrl" class="form-control" value="/sz0099/ood/article/manage/queryArticleManageList">
  ...
  <@M_coeArticleManagePage page=page moreLoaded="false" url="/sz0099/ood/article/manage/detail/" condition=entity/>
  <#--我的邀请二维码 	-->
<@M_qrCodeViewForIndex user=UserUtils.getUser()/>
  <@M_navBottomForManage category="ood" subCategory="article"  entity=entity/>
</div>
