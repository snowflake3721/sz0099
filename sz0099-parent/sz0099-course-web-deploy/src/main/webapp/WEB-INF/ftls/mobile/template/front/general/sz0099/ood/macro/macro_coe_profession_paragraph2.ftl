...
<#macro Mg_paragraphPhotoEdit paragraph=null>
<#-- 图片预览 -->
<div class="media">
	  <div class="media-left">
		    <a href="javascript:void(0)">
		      <img class="media-object" src="'+this.result+'" width="45px">
		    </a>
		     <div class="form-group form-group-sm">
			    <input type="text" id="id_parag_orderSeq" name="orderSeq" 
			    value="0" class="form-control" 
			    onkeyup="keyPressPositive(this)" 
				onafterpaste="onAfterPastePositive(this)"
				onchange="onChangeShow(\"id_parag_orderSeq_show\",this.value)"
			    placeholder="排序">
			  </div>
	  </div>
	  <div class="media-body">
	  		<div class="form-group form-group-sm">
		    <textarea id="id_parag_description" name="description" rows="5" class="form-control" placeholder="段落内容，少于255字">能和心爱的人一起睡觉，是件幸福的事情；可是，打呼噜怎么办？</textarea>
		  	</div>
	  </div>
</div>
</#macro>