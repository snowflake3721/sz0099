...
<#include "mobile/template/front/default/sz0099/ood/macro/macro_coe_activity_paragraph.ftl">
...
<#macro M_coeActivityCreate entity=null url="/sz0099/ood/home/activity/index/recommend?st=general">   
<!--创建活动，简易版--> 
...
<div class="list-group">
  <a href="javascript:void(0)" class="list-group-item active">
    ...
    <p class="list-group-item-text">1.录入活动>>基本信息</p>
	<p class="list-group-item-text">2.录入活动>>标题</p>
	<p class="list-group-item-text">3.录入活动>>段落主体及图片</p>
	<p class="list-group-item-text">4.录入活动>>设置标签</p>
	<p class="list-group-item-text">5.录入活动>>发布</p>
  </a>
</div>
...
<ul class="nav nav-tabs" role="tablist" id="id_tab_create">
	    <li role="presentation" class="active" ><a href="#panel_baseinfo" aria-controls="panel_baseinfo" role="tab" data-toggle="tab" data-saveUrl="/sz0099/ood/activity/manage/merge/baseinfo">基本</a></li>
	    <li role="presentation"><a href="#panel_price" aria-controls="panel_price" role="tab" data-toggle="tab" data-saveUrl="/sz0099/ood/activity/manage/merge/title">标题</a></li>
...
<div class="tab-content">
    ...
    <div id="id_messageTip_baseinfo${contentModel.id}" class="text-center"></div>
    	  ...
    	  <div class="form-group form-group-sm">
		    ...
		    value="${contentModel.name}" class="form-control" placeholder="活动标题">
		  </div>
		  <div class="form-group form-group-sm">
		    <label for="id_area_description${contentModel.id}"  class="text-danger">简要描述(少于255字符)★</label>
		    <textarea id="id_area_description${contentModel.id}" rows="8" class="form-control" placeholder="活动描述，少于255字">${contentModel.description}</textarea>
		  </div>
    		<#-- 封面图开始 -->
    			<label class="col-sm-2 control-label text-danger" for="id_cover_file_${contentModel.id}" >封面图★</label>
    			<div class="file-loading">
					<input id="id_cover_file_${contentModel.id}" data-devId="sz0099" data-project="ood" data-module="activity" data-variety="activity" data-strategy="1" data-position="cover" data-mainId="${contentModel.id}" data-subId="${PhotoCover.SUBID_COVER_HEAD}" type="file" name="files" />
				</div>
				<p class="text-danger">
					<small>
    			...
    			<div class="file-loading">
					<input id="id_banner_file_${contentModel.id}" data-devId="sz0099" data-project="ood" data-module="activity" data-variety="activity" data-strategy="3" data-position="banner" data-mainId="${contentModel.id}" data-subId="${PhotoBanner.SUBID_BANNER_HEAD}" type="file" name="files" />
				</div>
				<p class="text-danger">
					<small>
    ...
    <div role="tabpanel" class="tab-pane fade" id="panel_price" data-saveUrl="/sz0099/ood/activity/manage/merge/title">
    	<div class="text-danger text-center">★ 为必填项</div>
    ...
    <div role="tabpanel" class="tab-pane fade" id="contentTag" data-saveUrl="">
    	...
    	<br/>
    	<p><strong>1.为活动增加标签，最多加<b> 5  </b>个</strong></p>
