...
<#-- 图文横滚 -->
<#macro Mg_layout_headRoller ref=null dto=null showHeadTip=false withPreIntro=true withTitle=true withSubTitle=true showListLoadMore=false showPreNext=true showDot=true btnLabel="更多活动" idPre="ly_head">
<#if dto!>
	    	...
	    	<#if positionHas>
	         ...
	         <#if categoryHas>
	           <#list categoryList as category>
	           		...
	           		<#assign categoryEntity=category.activity/>
		          ...
		          <div class="item <#if showActive2==0>active</#if>" style="height:210px">
		            	...
		            	<img data-src="holder.js/280x210/auto/#777:#777" alt="${positionEntity.title}" height="210px" src="${coverImageUrl}" title="${positionEntity.title}" data-holder-rendered="true">
		          		<div class="carousel-caption">
		          			<#if withPreIntro && positionEntity.preIntro! && CoeActivity.PREINTRO_TYPE_NO.valueInt!=positionEntity.preIntroType>
	          ...
	          <#list categoryList as category>
		          ...
		          <div class="item <#if showActive2==0>active</#if>" style="height:210px">
		            	...
		            	<img data-src="holder.js/280x210/auto/#777:#777" alt="${categoryEntity.title}" height="210px"  src="${coverImageUrl}" title="${categoryEntity.title}" data-holder-rendered="true">
		          		<div class="carousel-caption">
		          			<#if withPreIntro && categoryEntity.preIntro! && CoeActivity.PREINTRO_TYPE_NO.valueInt!=categoryEntity.preIntroType>
	...
	<#if showListLoadMore>
     <@M_activitySearchHiddenInHomeDto dto=dto url="/sz0099/ood/home/activity/searchForCategoryFromHome" btnLabel=btnLabel idPre=idPre/>
     <#-- 
		    			...
		    			<#assign isEvenItem=categoryEntity?is_even_item />
		    				<#if isOddItem>
						  	<div class="row">
								  ...
								  <div class="col-xs-6 col-md-4">
								  <p>---888---8----</p>
								    	<@Mg_layout_imgCoverRollerH_single entity0=categoryEntity.activity idPre=idPre withPreIntro=withPreIntro withTitle=withTitle withSubTitle=withSubTitle showLoadMore=showLoadMore showDot=showDot showPreNext=showPreNext showPenname=showPenname linkable=linkable/>
								  </div>
	...
	<#if positionHas || categoryHas>
		<#if positionHas>
			...
			<#list categoryList as categoryEntity>
				<#assign isOddItem=categoryEntity?is_odd_item />
				<#assign isEvenItem=categoryEntity?is_even_item />
				<#assign entity0=categoryEntity.activity />
				  <div class="panel panel-default" sytle="margin-bottom:0px;padding-bottom:0px">
					  <#-- 
					  <div class="panel-heading">
...
<#if dto!>
	...
	<#if (positionHas || categoryHas)>
		...
		<#assign categoryEntity=categoryList?first />
			<@M_layout_jumbotron_single entity0=categoryEntity.activity idPre=idPre+"category" tip="独家记忆" tipShowable=false btnLabel="进入>>>"  withPreIntro=true withTitle=true withSubTitle=true showPreNext=false showPenname=false linkable=true/>
		</#if>
		<#if showListLoadMore >
		<@M_activitySearchHiddenInHomeDto dto=dto url="/sz0099/ood/home/activity/searchForCategoryFromHome" btnLabel=btnLabel idPre=idPre/>
		</#if>
	          ...
	          <#list categoryList as categoryEntity>
		          ...
		          <div class="item <#if slideIndex2==0>active</#if>">
		            	...
		            	<#if showPenname>
							  ...
							  <span class="pull-left">
							  <strong> 
							  <#if entity0.activityTagList!?size gt 0 > 
							  	<@M_showTagListRandom productTagList=entity0.activityTagList idPre="tag_detail_" entity0=entity0 fontSize=12 randomSize=false withWrapper=false/>
							  	</#if>
			  					</strong>
			  					</span>
							  <img id='id_tpl_media_headImg${entity0.id}' <#if mainCircle>onclick="changeBloomingForJson('/sz0099/ood/activity/findByUserId','${entity0.userId}','id_current_userId')"</#if> class='img-circle pull-right'  width='20px' height='20px' src='${entity0.headImg}' alt='${entity0.nickname}' title='${entity0.nickname}'>
				...
				<#assign entity0=categoryEntity.activity />
						  	<div class="row">
								  ...
								  <div class="col-xs-6 col-md-4">
									...
									<small>
									<#if withPreIntro && entity0.preIntro! && CoeActivity.PREINTRO_TYPE_NO.valueInt!=entity0.preIntroType>
