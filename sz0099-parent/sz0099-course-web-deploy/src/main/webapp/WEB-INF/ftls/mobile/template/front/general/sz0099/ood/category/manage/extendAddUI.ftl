...
<@M_navBreadForManage category="category" subCategory="new" entity=entity/>
 -->
<@M_navBreadForCategory category="category" subCategory="new" showView="detail"  entity=entity/>
...
<script>document.write("<script type='text/javascript' src='/assets/theme/general/sz0099/ood/category/manage/category_sub.js?v=1.0.1'><\/script>");</script>
