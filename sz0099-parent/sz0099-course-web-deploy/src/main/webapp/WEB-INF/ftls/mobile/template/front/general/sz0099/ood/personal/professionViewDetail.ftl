...
<@M_navBreadForCategory category="qunxia" subCategory="profession" showView="detail"  entity=entity/>
<#if page! && entity!>
  ...
  <@M_professionDetailView entity=entity paragraphPage=page moreLoaded="true" />
</#if>

<@M_navBottomForCategory category="qunxia" subCategory="profession" showView="detail"  entity=entity/>
<@shiro.user>
<#--我的邀请二维码 	-->
...
<input type="hidden" value="${login_status}" name="login_status" id="id_login_status"
	...
	data-title="技能：${entity.title}-<@shiro.principal property="nickname"/>"
