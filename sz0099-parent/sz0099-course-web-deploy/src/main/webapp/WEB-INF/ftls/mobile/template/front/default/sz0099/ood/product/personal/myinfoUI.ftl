...
<@shiro.user>
<@M_navBreadForMy category="info" subCategory="baseinfo" entity=entity/>
  ...
  个人资料修改</h4></div>
	...
	<@M_navBottomForMy category="info" subCategory="baseinfo" entity=entity />
</@shiro.user>
</div>
...
<script>document.write("<script type='text/javascript' src='/assets/theme/default/sz0099/ood/product/personal/myinfo.js?v=1.0.0'><\/script>");</script>
