...
<div class="container " id="body_content">
	<div id="id_profession_personal" class="container" style="z-index:5002"></div>
  	<@Mg_activityCategoryForSearchFromDetail entityPage=page categoryRef=entity categoryTree=categoryTree url="/sz0099/ood/activity/searchForCategoryFromDetail"/>
	...
	<@M_coeCategActivityPage itemPage=page moreLoaded="false" url="/sz0099/ood/activity/searchForCategoryFromDetail" condition=entity/>
	<@M_introduction/>
