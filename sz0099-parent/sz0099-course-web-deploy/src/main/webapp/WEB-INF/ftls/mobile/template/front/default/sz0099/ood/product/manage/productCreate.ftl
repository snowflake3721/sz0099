...
<@M_navBreadForManage category="product" subCategory="new" entity=entity/>

  <div class="text-center text-primary"><h5>录入产品</h5></div>
  <p>产品编号：${entity.productNo} </p>
  <p class="word-break">链接: ${entity.originalLink} </p>
  <input type="hidden" name="id" id="id_hidden_id" value="${entity.id}"/>
  <@M_coeProductCreate product=entity url="/sz0099/ood/product/manage/create"/>

  <@M_navBottomForManage category="product" subCategory="new"  entity=entity/>
</div>

<div class="container" id="body_footer_js">	
<script>document.write("<script type='text/javascript' src='/assets/common/tools/wangEditor/3.1.1/wangEditor.js?v=1.1.0'><\/script>");</script>
...
$(document).ready(function(){
	...
	$('#id_tab_create a').click(function (e) {
	  	...
	  	$(this).tab('show');
	  	loadData(href,'/sz0099/ood/product/manage/paragraph/editListUI');
