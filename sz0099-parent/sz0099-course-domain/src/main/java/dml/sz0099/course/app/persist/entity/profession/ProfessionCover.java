...
@Entity
@Table(name="s9_pro_ProfessionCover")
public class ProfessionCover extends BaseEntityExtendLong implements Serializable {

	private static final long serialVersionUID = -4795277758856470669L;

	@Column(name="refId", length = 20, columnDefinition = "BIGINT(20) COMMENT '技能refId'")
	private Long refId;
