...
public class PhotoParag extends BaseEntityExtendLong implements Serializable {
	...
	@Column(name="templateId", length = 20, columnDefinition = "BIGINT(20) COMMENT '关联模版Id'")
	private Long templateId;
	
	@Transient
	private Paragraph parag;
	
	@Column(name="mainId",length=20,columnDefinition="BIGINT(20) COMMENT '文章id,mainId=Activity.id'")
	private Long mainId;
