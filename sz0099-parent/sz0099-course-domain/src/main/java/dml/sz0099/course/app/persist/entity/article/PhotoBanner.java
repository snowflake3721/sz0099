...
@Entity
@Table(name="s9_art_PhotoBanner")
public class PhotoBanner extends BaseEntityExtendLong implements Serializable {

	private static final long serialVersionUID = -6536620488659080007L;
	
	public static final Long SUBID_BANNER_HEAD=dml.sz0099.course.app.persist.entity.paragraph.PhotoBanner.SUBID_BANNER_HEAD;//对应图片位置为头部滚动
	public static final Long SUBID_BANNER_FOOT=dml.sz0099.course.app.persist.entity.paragraph.PhotoBanner.SUBID_BANNER_FOOT;//对应图片位置为尾部滚动
	...
	@Column(name="mainId",length=20,columnDefinition="BIGINT(20) COMMENT 'mainId=productId'")
	private Long mainId;
