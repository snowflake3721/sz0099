 ...
 */
@Entity
@Table(name="s9_ImageExtendLog")
public class ImageExtendLog extends BaseEntityExtendLong implements Serializable{
	...
	@Transient
	private ImageExtendContent content;
	...
	public ImageExtendContent getContent() {
		return content;
	}

	public void setContent(ImageExtendContent content) {
