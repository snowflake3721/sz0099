...
@Entity
@Table(name="s9_act_ActivityPositionCover")
public class CoeActivityPositionCover extends BaseEntityExtendLong implements Serializable {
	...
	private Long refId;//也即refId=PositionRef.id=CoeActivityPosition.id
