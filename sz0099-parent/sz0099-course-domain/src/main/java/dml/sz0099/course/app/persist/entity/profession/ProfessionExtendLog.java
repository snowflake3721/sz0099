 ...
 */
@Entity
@Table(name="s9_ProfessionExtendLog")
public class ProfessionExtendLog extends BaseEntityExtendLong implements Serializable{
	...
	@Transient
	private ProfessionExtendContent content;
	...
	public ProfessionExtendContent getContent() {
		return content;
	}

	public void setContent(ProfessionExtendContent content) {
