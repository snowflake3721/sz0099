 ...
 */
@Entity
@Table(name="s9_CategoryExtendLog")
public class CategoryExtendLog extends BaseEntityExtendLong implements Serializable{
	...
	@Transient
	private CategoryExtendContent content;
	...
	public CategoryExtendContent getContent() {
		return content;
	}

	public void setContent(CategoryExtendContent content) {
