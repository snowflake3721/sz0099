...
public class PhotoCover extends BaseEntityExtendLong implements Serializable {
	...
	public static final Long SUBID_COVER_HEAD=10l;//对应图片位置为封面首
	public static final Long SUBID_COVER_FOOT=11l;//对应图片位置为封面尾
	...
	@Column(name="mainId",length=20,columnDefinition="BIGINT(20) COMMENT 'mainId=articleId'")
	private Long mainId;
