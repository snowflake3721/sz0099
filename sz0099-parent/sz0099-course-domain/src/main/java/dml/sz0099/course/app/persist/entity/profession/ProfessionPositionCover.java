...
@Entity
@Table(name="s9_pro_PositionCover")
public class ProfessionPositionCover extends BaseEntityExtendLong implements Serializable {


	//id 存 PositionCover.id
	
	private static final long serialVersionUID = 3467556213858777742L;
