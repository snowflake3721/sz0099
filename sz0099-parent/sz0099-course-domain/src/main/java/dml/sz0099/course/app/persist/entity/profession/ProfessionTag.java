...
@Entity
@Table(name="s9_pro_ProfessionTag")
public class ProfessionTag extends BaseEntityExtendLong implements Serializable {

	private static final long serialVersionUID = -7481162195005128432L;
	
	//@Transient
	//@Column(length = 20, columnDefinition = "BIGINT(20) COMMENT '技能Id'")
