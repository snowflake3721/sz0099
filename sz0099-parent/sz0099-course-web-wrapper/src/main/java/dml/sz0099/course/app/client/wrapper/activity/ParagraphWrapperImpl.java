...
import dml.sz0099.course.app.biz.delegate.activity.ActivityParagraphDelegate;
 ...
 * </pre>
 */
@Service("activityParagraphWrapperImpl")
public class ParagraphWrapperImpl implements ParagraphWrapper {
	...
	@Autowired
	private ActivityParagraphDelegate paragraphDelegate;
	...
	public Paragraph createParagraph(Paragraph paragraph ){		
		...
		LOGGER.debug("-------wrapper>>>ParagraphWrapperImpl.createParagraph----------begin---------");
