...
import dml.sz0099.course.app.biz.delegate.activity.ActivityPhotoDelegate;
 ...
 * </pre>
 */
@Service("activityPhotoWrapperImpl")
public class PhotoWrapperImpl implements PhotoWrapper {
	...
	@Autowired
	private ActivityPhotoDelegate photoDelegate;
	...
	public Long countNotSelfByFilename(Long id, String filename) {
		return photoDelegate.countNotSelfByFilename(id, filename);
	}
