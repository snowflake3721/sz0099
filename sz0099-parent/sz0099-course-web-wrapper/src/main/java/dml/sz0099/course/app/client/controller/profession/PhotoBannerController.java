...
import dml.sz0099.course.app.client.validator.profession.PhotoBannerValidator;
...
@Controller("professionPhotoBannerController")
public class PhotoBannerController {
	...
	public String create(@ModelAttribute("ref") ImageRef ref, Model model, HttpServletRequest request) {
		...
		String resultPath = ResourcePathConfig.generateUrlPath(TLE_DEFALT_FRONT, MAPPING_PATH_PERSONAL,"cover/create");
	...
	public String delete(@ModelAttribute("ref") PhotoBanner ref, Model model, HttpServletRequest request) {
		...
		String resultPath = ResourcePathConfig.generateUrlPath(TLE_DEFALT_FRONT, MAPPING_PATH_PERSONAL, "commonResult");
	...
	public String addImageRef(@ModelAttribute("ref") ImageRef ref, Model model, HttpServletRequest request) {
		...
		String resultPath = ResourcePathConfig.generateUrlPath(TLE_DEFALT_FRONT, MAPPING_PATH_PERSONAL,"cover/addRefImage");
