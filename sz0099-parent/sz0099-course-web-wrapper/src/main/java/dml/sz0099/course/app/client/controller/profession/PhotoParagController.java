...
import dml.sz0099.course.app.client.validator.profession.PhotoParagValidator;
...
@Controller("profPhotoParagController")
public class PhotoParagController {
	...
	//模块缩略名称目录
	private String MODULE_PATH_PARAGRAPH = ResourcePathConfig.getModulesPath(CourseAppModule.APP_COURSE_PERSONAL.getAd());
	//模块主目录,一般与模块缩略名称相同
	private String MAPPING_PATH_PARAGRAPH = ResourcePathConfig.getModulesPath(CourseAppModule.APP_COURSE_PERSONAL_PATH.currentPath());
	//模块二级目录
	private String MAPPING_SUB_PATH_PARAGRAPH = ResourcePathConfig.getModulesPath(CourseAppModule.APP_COURSE_PERSONAL_PATH_BASIC.currentPath());
	...
	public String create(@ModelAttribute("ref") ImageRef ref, Model model, HttpServletRequest request) {
		...
		String resultPath = ResourcePathConfig.generateUrlPath(TLE_DEFALT_FRONT, MAPPING_PATH_PARAGRAPH,"parag/create");
	...
	public String delete(@ModelAttribute("ref") PhotoParag ref, Model model, HttpServletRequest request) {
		...
		String resultPath = ResourcePathConfig.generateUrlPath(TLE_DEFALT_FRONT, MAPPING_PATH_PARAGRAPH,"commonResult");
	...
	public String addImageRef(@ModelAttribute("ref") ImageRef ref, Model model, HttpServletRequest request) {
		...
		String resultPath = ResourcePathConfig.generateUrlPath(TLE_DEFALT_FRONT, MAPPING_PATH_PARAGRAPH,"parag/addRefImage");
