...
import dml.sz0099.course.app.biz.delegate.profession.ProfParagraphDelegate;
 ...
 * </pre>
 */
@Service("profParagraphWrapperImpl")
public class ParagraphWrapperImpl implements ParagraphWrapper {
	...
	@Autowired
	private ProfParagraphDelegate paragraphDelegate;
