...
import dml.sz0099.course.app.biz.delegate.article.ArticleParagraphDelegate;
 ...
 * </pre>
 */
@Service("articleParagraphWrapperImpl")
public class ParagraphWrapperImpl implements ParagraphWrapper {
	...
	@Autowired
	private ArticleParagraphDelegate paragraphDelegate;
