...
import dml.sz0099.course.app.client.wrapper.article.PhotoCoverWrapper;
...
public class CoverArticleAdaptor extends ImageDefaultAdaptor<CoeArticle>{
	...
	public CoeArticle convert(ImageExtend imageExtend) {
		...
		if(null != imageExtend) {
			...
			if(null != images && !images.isEmpty()) {
				...
				article.setCoverList(coverList);
	...
	public boolean persist(CoeArticle t) {
		CoeArticle entity = articleWrapper.persistForCover(t);
