...
import dml.sz0099.course.app.biz.service.paragraph.PhotoService;
 ...
 */
@Service
public class PhotoDelegateImpl implements PhotoDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(PhotoDelegateImpl.class);
