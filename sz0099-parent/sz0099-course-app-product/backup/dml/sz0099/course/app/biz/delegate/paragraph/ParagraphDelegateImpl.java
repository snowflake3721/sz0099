...
import dml.sz0099.course.app.biz.service.paragraph.ParagraphService;
 ...
 */
@Service
public class ParagraphDelegateImpl implements ParagraphDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(ParagraphDelegateImpl.class);
	...
	public Paragraph createParagraph(Paragraph paragraph ){		
		...
		Paragraph paragraph = paragraphService.createParagraph( paragraph );

		LOGGER.info("-------delegate>>>ParagraphDelegateImpl.createParagraph----------end---------");
