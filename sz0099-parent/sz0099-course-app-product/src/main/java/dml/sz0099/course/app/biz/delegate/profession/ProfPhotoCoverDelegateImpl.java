...
import dml.sz0099.course.app.biz.service.profession.PhotoCoverService;
 ...
 */
@Service
public class ProfPhotoCoverDelegateImpl implements ProfPhotoCoverDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(ProfPhotoCoverDelegateImpl.class);
