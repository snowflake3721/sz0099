 ...
 * 
 */
public interface CategProfessionService extends GenericService<CategProfession,Long>{
	 ...
	 * @return
	 */
	public CategProfession persistEntity(CategProfession coeCategArticle) ;
	
	
	public CategProfession mergeEntity(CategProfession coeCategArticle) ; 
	
	public CategProfession saveOrUpdate(CategProfession coeCategArticle) ;
	...
	public CategProfession changeCategory(CategProfession coeCategArticle);
