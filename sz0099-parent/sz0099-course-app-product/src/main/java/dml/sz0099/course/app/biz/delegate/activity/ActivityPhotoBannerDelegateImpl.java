...
import dml.sz0099.course.app.biz.service.activity.PhotoBannerService;
 ...
 */
@Service
public class ActivityPhotoBannerDelegateImpl implements ActivityPhotoBannerDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(ActivityPhotoBannerDelegateImpl.class);
