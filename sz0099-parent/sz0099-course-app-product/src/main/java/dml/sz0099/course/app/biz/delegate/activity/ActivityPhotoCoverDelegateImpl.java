...
import dml.sz0099.course.app.biz.service.activity.PhotoCoverService;
 ...
 */
@Service
public class ActivityPhotoCoverDelegateImpl implements ActivityPhotoCoverDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(ActivityPhotoCoverDelegateImpl.class);
