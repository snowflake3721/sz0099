...
import dml.sz0099.course.app.biz.service.paragraph.PhotoCoverService;
 ...
 */
@Service
public class PhotoCoverDelegateImpl implements PhotoCoverDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(PhotoCoverDelegateImpl.class);
