...
import dml.sz0099.course.app.persist.repository.activity.PhotoRepository;
import dml.sz0099.course.app.persist.specification.activity.PhotoSpecification;
 ...
 * 
 */
@Repository("activityPhotoDaoImpl")
public class PhotoDaoImpl extends GenericDaoImpl<Photo, Long> implements PhotoDao, Serializable {
	...
	public Long countNotSelfByFilename(Long id, String filename) {
		return photoRepository.countNotSelfByFilename(id, filename);
	}
