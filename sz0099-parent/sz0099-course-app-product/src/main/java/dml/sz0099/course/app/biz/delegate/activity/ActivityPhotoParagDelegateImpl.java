...
import dml.sz0099.course.app.biz.service.activity.PhotoParagService;
 ...
 */
@Service
public class ActivityPhotoParagDelegateImpl implements ActivityPhotoParagDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(ActivityPhotoParagDelegateImpl.class);
	...
	public void mergeTemplateById(PhotoParag photoParag) {
		photoParagService.mergeTemplateById(photoParag);
	}
	
	public Long countNotSelfByTemplateId(Long templateId) {
		return photoParagService.countNotSelfByTemplateId(templateId);
	}
}
