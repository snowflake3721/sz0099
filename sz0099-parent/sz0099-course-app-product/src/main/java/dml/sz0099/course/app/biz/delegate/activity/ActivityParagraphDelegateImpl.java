...
import dml.sz0099.course.app.biz.service.activity.ParagraphService;
 ...
 */
@Service
public class ActivityParagraphDelegateImpl implements ActivityParagraphDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(ActivityParagraphDelegateImpl.class);
