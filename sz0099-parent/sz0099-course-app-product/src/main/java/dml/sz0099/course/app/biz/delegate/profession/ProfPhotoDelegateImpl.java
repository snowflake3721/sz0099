...
import dml.sz0099.course.app.biz.service.profession.PhotoService;
 ...
 */
@Service
public class ProfPhotoDelegateImpl implements ProfPhotoDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(ProfPhotoDelegateImpl.class);
