...
public class AppCodeGenerator {
	...
	public static void config() {
		...
		CodeGenerator.GENERATE_CODE_STORED_PROJECT_AUTH="sz0099-course-app-product";//生成代码存放的工程
		CodeGenerator.ENTITY_PACKAGE_ROOT = "dml.sz0099.course.app.persist.entity.position";
