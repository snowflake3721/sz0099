...
import dml.sz0099.course.app.biz.service.profession.PhotoParagService;
 ...
 */
@Service
public class ProfPhotoParagDelegateImpl implements ProfPhotoParagDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(ProfPhotoParagDelegateImpl.class);
