...
import dml.sz0099.course.app.biz.service.profession.PhotoBannerService;
 ...
 */
@Service
public class ProfPhotoBannerDelegateImpl implements ProfPhotoBannerDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(ProfPhotoBannerDelegateImpl.class);
