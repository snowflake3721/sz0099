...
import dml.sz0099.course.app.biz.service.profession.ParagraphService;
 ...
 */
@Service
public class ProfParagraphDelegateImpl implements ProfParagraphDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(ProfParagraphDelegateImpl.class);
