...
import dml.sz0099.course.app.biz.service.activity.PhotoService;
 ...
 */
@Service
public class ActivityPhotoDelegateImpl implements ActivityPhotoDelegate, Serializable {

	private static final Logger LOGGER = LoggerFactory.getLogger(ActivityPhotoDelegateImpl.class);
	...
	public Long countNotSelfByFilename(Long id, String filename) {
		return photoService.countNotSelfByFilename(id, filename);
	}
